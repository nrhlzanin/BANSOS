...
@section('content')
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('petugas.data-akun-warga') }}">Data Akun Warga</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('petugas.data-akun-warga.update', $akun->id_user) }}" method="POST">
                    @csrf
                    @method('PUT')
