...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #127C56;">
  ...
  <a href="{{ url('/') }}" class="brand-link">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- Data Warga -->
        <li style="margin: 10px 0;" class="custom-nav-item nav-item has-treeview {{ request()->is('admin/data-warga', 'admin/validasi') ? 'menu-open' : '' }}">
        ...
        <!-- Informasi Akun -->
        <li class="custom-nav-item nav-item" style="margin: 10px 0;">
