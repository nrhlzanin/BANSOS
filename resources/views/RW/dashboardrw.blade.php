    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box"
                                style="background-color: #b8efdc; position: relative; overflow: hidden;">
                                <div class="inner"
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box"
                                ...
                                <a href="{{ route('admin.informasi-bansos') }}" class="small-box-footer"
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box"
                                ...
                                <div class="inner"
                                    style="padding: 10px; color: black; display: flex; justify-content: center; align-items: center;">
                                    <img src="{{ asset('img/ranking.png') }}" alt="Your Image"
                                        style="width: 50%; height: auto; border-radius: 5px;">
                                </div>
                                <div class="icon" style="position: absolute; top: 10px; right: 10px;">
                                    <i class="ion ion-bag"></i>
                                </div>
                                <a href="{{ route('perangkingan.index') }}" class="small-box-footer"
                                    style="display: block; text-align: center; padding: 10px; background: rgba(0, 0, 0, 0.1); border-top: 1px solid rgba(0, 0, 0, 0.1); color: black;">Perankingan
            ...
            <iframe class="mx-auto" width="1200" height="450"
                src="https://lookerstudio.google.com/embed/reporting/84bbb4c5-7abc-4494-b344-b143d6faed53/page/p_bee5t6e1hd"
